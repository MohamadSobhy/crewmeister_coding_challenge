...
/// The class contains properties such as [count] and [absences] to represent
/// the number of absences and a list of absence models.
///
class AbsencesResponseModel extends AbsencesResponse {
  const AbsencesResponseModel({required super.count, required super.absences});
  ...
  @override
  List<Object?> get props => [count, absences];
}
